...
import groceryImage from '../assets/images/d.jpeg'; // Replace with your actual image path
import ghoshMedicalImage from '../assets/images/d.jpeg'; // Replace with your actual image path
  ...
  return (
    <div className="services-container">
      ...
      <div className="service-card">
        ...
        <p>Proprietor: JpyDev Ghosh and Brother</p>
        <p>
          Contact: 
          <FontAwesomeIcon icon={faPhone} className="phone-icon" /> 
